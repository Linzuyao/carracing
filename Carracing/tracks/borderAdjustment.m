...
function [track,track2] = borderAdjustment(track2,carwidth,scale,safetyScaling)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% shrink track on both sides with 'WidthCar' %%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
WidthCar = 0.5*carwidth*safetyScaling;
%scale track to car size
track2.center = track2.center*scale;
track2.inner = track2.inner*scale;
track2.outer = track2.outer*scale;
